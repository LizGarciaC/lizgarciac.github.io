        ...
        if (this.state.activeTab === 0) {
            return (
                <div className='projects-grid'>
                    ...
                    <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
                    <CardTitle style={{ color: 'black', height: '35vh', background: 'url(https://abrilmdemulher.files.wordpress.com/2017/08/filtro-pikachu-snapchat.jpg) center / cover' }} ></CardTitle>
                    <CardText>
                    ...
                    <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
                    <CardTitle style={{ color: 'black', height: '36vh', background: 'url(https://viajaporelmundo.com.ar/wp-content/uploads/2018/02/vuelos-a-mexico-768x319.jpg) center / cover' }} ></CardTitle>
                    <CardText>
                        Red Social - Explora México
                        <hr/>
            ...
            return (
                ...
                <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
                    <CardTitle style={{ color: '#fff', height: '34vh', background: 'url(https://www.ubeo.app/cdn/products/11308/600x300/leganes-diner.png) center / cover' }} ></CardTitle>
                    <CardText>
                    Burger Queen
                    <hr/>
                    Interfaz para un pequeño restaurante de hamburguesas, que está creciendo y necesita tomar pedidos usando una tablet. La interfaz muestra dos menús (desayuno y resto del día), precios y el total de la compra.
                </CardText>
                <CardActions border>
                ...
                <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
                <CardTitle style={{ color: 'black', height: '32vh', background: 'url(https://i2.wp.com/elportaldesalta.com.ar/wp-content/uploads/2019/05/Google-Pixel-3a-7.jpg?resize=800%2C445&ssl=1) center / cover' }} ></CardTitle>
                <CardText>
                Open House - Food Finder 
                <hr/>
                Es una aplicación que te permite encontrar y conocer restaurantes cerca de ti. En la pagina principal podrás encontrar un mapa que te muestra tu ubicación y los restaurantes cercanos, también podrás seleccionar algunos filtros como órden alfabético ó rango de precios.
                </CardText>
                <CardActions border>
                ...
                <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
                <CardTitle style={{ color: 'black', height: '41vh', background: 'url(https://i.pinimg.com/736x/0d/c0/d9/0dc0d9fa716462f825e8e17a136677eb.jpg) center / cover' }} ></CardTitle>
                <CardText>
                Mobile Game / Espace Tic Tac Toe
                <hr/>
            ...
            return (
                ...
                {/* Card Proyectos en React - Burger Queen*/}
                <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
                    <cardTitle style={{ color: 'black', height: '44vh', background: 'url(http://linkredglue.com/wp-content/uploads/caspio-features-illustr_cloud-data_3_2x.png?w=640) center / cover' }} ></cardTitle>
                    <CardText>
